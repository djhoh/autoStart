/* HOH S.A.S.
29-SEP-2016
For device: Arduino Pro Micro
Autostart device **FINAL VERSION**
Reads start button state to power-on BBB*/

const int start = 14;//Retention from relay board
const int s1 = 15; //Auto-manual operation switch
const int t2 = 16; //Plant's Start button 
